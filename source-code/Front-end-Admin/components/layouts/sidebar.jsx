                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link href="/manage-orders">{t('Manage Orders')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/manage-products">{t('Manage Products')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/manage-categories">{t('Manage Categories')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/manage-reviews">{t('Manage Reviews')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/manage-discounts">{t('Manage Discounts')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/manage-refunds">{t('Manage Refunds')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/manage-returns">{t('Manage Returns')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
