...
const CreateProduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(error.response?.data?.message || 'Đã xảy ra lỗi khi thêm sản phẩm. Vui lòng thử lại.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="panel mt-6">
            <div className="mb-5 flex items-center justify-between">
                <h5 className="text-lg font-semibold dark:text-white-light">Thêm sản phẩm mới</h5>
                <button 
                    type="button" 
